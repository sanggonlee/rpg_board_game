...
monster_data = {
    ...
    'evil mage': (MONSTER_TYPE_BOSS, 'Evil Mage', 'evil_mage.png', 2, 60, 12, 0),
    'demon king gaias': (MONSTER_TYPE_BOSS, 'Demon King Gaias', 'demon_king_gaias.png', 4, 120, 25, 1),
}
...
tile_data = [
    ...
    (TILE_GOLD, 5),
    (TILE_MONSTER, [(monster_data['bandit'], (0, 1)),
                    (monster_data['bandit'], (1, 1)),
                    (monster_data['bandit'], (0, 2)),
                    (monster_data['bandit'], (1, 2))]),
    (TILE_MONSTER, [(monster_data['boar'], (0, 1)),
                    (monster_data['boar'], (1, 1)),
                    (monster_data['boar'], (0, 2)),
                    (monster_data['boar'], (1, 2))]),
    (TILE_GOLD, 10),
    (TILE_HEAL, 100),
    (TILE_RESPAWN,),
    ...
    (TILE_MONSTER, [(monster_data['orc'], (0, 1)),
                    (monster_data['orc'], (1, 1)),
                    (monster_data['orc'], (0, 2)),
                    (monster_data['orc'], (1, 2))]),
    (TILE_HEAL, 100),
    (TILE_MONSTER, [(monster_data['skeleton'], (0, 1)),
                    (monster_data['skeleton'], (1, 1)),
                    (monster_data['skeleton'], (0, 2)),
                    (monster_data['skeleton'], (1, 2))]),
    (TILE_ARMOR_SHOP, [armor_data['quilt shirts'], armor_data['leather jacket'], armor_data['ring mail']]),
    (TILE_GOLD, 10),
    (TILE_RESPAWN,),
    (TILE_MONSTER, [(monster_data['fallen knight'], (0, 1)),
                    (monster_data['fallen knight'], (1, 1)),
                    (monster_data['fallen knight'], (0, 2)),
                    (monster_data['fallen knight'], (1, 2))]),
    (TILE_HEAL, 100),
    (TILE_MONSTER, [(monster_data['orc'], (0, 1)),
                    (monster_data['orc'], (1, 1)),
                    (monster_data['orc'], (0, 2)),
                    (monster_data['orc'], (1, 2))]),
    (TILE_MONSTER, [(monster_data['evil mage'], (1, 2)),
                    (monster_data['skeleton'], (0, 1)),
                    (monster_data['skeleton'], (0, 2)),
                    (monster_data['skeleton'], (0, 3))]),
]